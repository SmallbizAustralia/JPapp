                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding">User Information</td>
                                        </tr>
                                        <tr>
                                            <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding">
                                                ...
                                                <p><strong>Starting Weight:</strong> {{ $user->starting_weight }}</p>
                                                <p><strong>Current Weight:</strong> {{ $user->current_weight }}</p>
                                                <p><strong>Goal Weight:</strong> {{ $user->goal_weight }}</p>
                                                <p><strong>Email:</strong> {{ $user->email }}</p>
                                                <p><strong>Contact Number:</strong> {{ $user->timezone }}</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
