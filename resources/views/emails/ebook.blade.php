                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding">Hi there,</td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding">
                                                <p>Thanks for purchasing The Complete Strength And Testosterone Enhancement Guide For Men, you're going to absolutely love the guide and it is going to play a huge role in your success and your future results!</p>
                                                <p>Please find the guide attached!</p>
                                                <p>Kind regards,<br>Jay Piggin</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
